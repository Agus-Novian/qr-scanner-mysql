package com.agus.qrcode.custom;
...
public class SertifikatView extends LinearLayout {
    ...
    public SertifikatView(Context context) {
        super(context);
        Init();
    }

    public SertifikatView(Context context, AttributeSet attrs) {
        super(context, attrs);
        Init();
    }
